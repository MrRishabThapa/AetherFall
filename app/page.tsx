      ...
      <main className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-6">
          ...
          >
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <span className="text-white">Rishab:</span> integration, camera,
                missions, final build
              </li>
              <li>
                <span className="text-white">Anup:</span> animal AI, boss
                behavior
              </li>
              <li>
                <span className="text-white">Roshni + Vishal:</span> map art,
                UI, dialogue visuals, portal
              </li>
              <li>
